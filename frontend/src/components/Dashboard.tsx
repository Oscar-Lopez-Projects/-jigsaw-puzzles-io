        ...
        <>
          ...
          <div className="dashboard-stats">
            <div className="stat-card">
              <span className="stat-value">{totalPuzzles}</span>
              <span className="stat-label">Puzzles Solved</span>
            </div>
            <div className="stat-card">
              <span className="stat-value">{bestTime > 0 ? formatTime(bestTime) : '—'}</span>
              <span className="stat-label">Best Time</span>
            </div>
            <div className="stat-card">
              <span className="stat-value">{avgStars > 0 ? avgStars.toFixed(1) : '—'}</span>
            ...
            <div className="stat-card">
              <span className="stat-value">{threeStarCount}</span>
              <span className="stat-label">3-Star Solves</span>
            </div>
          </div>
          ...
          <div className="dashboard-records">
            ...
            {records.length === 0 ? (
              <p className="records-empty">
                No puzzles solved yet. Complete a puzzle to see your records here!
              </p>
            ) : (
                  ...
                  <div className="record-row" key={record.id}>
                    <div className="record-info">
                      <span className="record-name">
                        {record.image_reference || 'Puzzle'}
                      </span>
                      <span className="record-meta">
                        {record.piece_count} pieces · {record.difficulty} · {formatDate(record.completed_at)}
                      </span>
                    </div>
