  ...
  return (
    <div className="win-overlay" role="dialog" aria-modal="true" aria-label="Puzzle complete">
      <div className="win-card">
        ...
        {!isLoggedIn && (
          <p className="win-guest-notice">
            Playing without an account does not save your progress.
          </p>
        )}
        ...
        <div className="win-actions">
          {isLoggedIn ? (
            <button type="button" className="win-btn win-btn--primary" onClick={onDashboard}>
              View Dashboard
            </button>
          ) : (
            <>
              <button type="button" className="win-btn win-btn--primary" onClick={onCreateAccount}>
                Create Account
              </button>
              <button type="button" className="win-btn win-btn--secondary" onClick={onPlayAgain}>
                Play Again
              </button>
            </>
          )}
